                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="IPA" <?php if ($siswa['jurusan'] == 'IPA') { ?>
                                        selected='' <?php } ?>>IPA</option>
                                   <option value="BAHASA"
                                        <?php if ($siswa['jurusan'] == 'BAHASA') { ?> selected=''
                                        <?php } ?>>BAHASA</option>
                                   <option value="IPS" <?php if ($siswa['jurusan'] == 'IPS') { ?>
                                        selected='' <?php } ?>>IPS</option>
                                   <option value="MULTIMEDIA"
                                        <?php if ($siswa['jurusan'] == 'MULTIMEDIA') { ?> selected=''
                                        <?php } ?>>MULTIMEDIA</option>
                                   <option value="AGAMA" <?php if ($siswa['jurusan'] == 'AGAMA') { ?>
                                        selected='' <?php } ?>>AGAMA</option>
                                   <option value="SENDRATASIK" <?php if ($siswa['jurusan'] == 'SENDRATASIK') { ?>
                                        selected='' <?php } ?>>SENDRATASIK</option>
                              </select>
                         </div>
                         <div class="mb-3">
